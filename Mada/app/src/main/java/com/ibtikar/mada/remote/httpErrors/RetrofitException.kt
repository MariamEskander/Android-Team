package com.ibtikar.mada.remote.httpErrors

import com.google.gson.Gson
import com.ibtikar.mada.remote.BaseResponse
...
//    private var _errorData : ServerError? = null
    ...
    companion object {
        ...
        fun httpError(url: String, response: Response<*>, retrofit: Retrofit, throwable: HttpException): RetrofitException {
            val message: String = Gson().fromJson(throwable.response().errorBody()?.string(), BaseResponse::class.java).Message.toString()
        ...
        fun unexpectedError(exception: Throwable): RetrofitException {
            return RetrofitException(null, exception.message, null, null, Kind.UNEXPECTED, exception, null)
        }
    }
